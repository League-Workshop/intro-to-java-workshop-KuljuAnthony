...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	private void scare() {
		...
		//9. Find a scary sound and put it in the section5 package where you put your maze picture.
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("bobsound.wav"));
	...
	private void showScaryImage(String imageName) {
		try {
			maze = ImageIO.read(getClass().getResource("download.jpeg"));
		} catch (Exception e) {
			System.err.println("Couldn't find this image: " + "download.jpeg");
		}
		repaint();
	}
